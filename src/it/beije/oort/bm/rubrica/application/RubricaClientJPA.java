...
public class RubricaClientJPA {
	...
	private static List<Contatto> selectContact() throws IOException {
	...
	private static boolean addContact() throws IOException {
	...
	private static boolean updateContact() throws IOException {
		int id;
		String[] vals = new String[4];
		boolean[] sel = new boolean[4];
	...
	private static boolean deleteContact() throws IOException {
		int id;
		System.out.println("Insert contact id:");
		try {
			id = Integer.parseInt(in.readLine().trim());
