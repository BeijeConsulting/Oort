...
import static csvandxml.CsvToXml.stringToArrayList;
import static csvandxml.XmlToCsv.readContacts;
import static csvandxml.XmlToCsv.*;
public class CsvXmlOverwriter {
	...
	public static List<csvandxml.ContactXml> xmlToContact (File file) throws Exception {
		List<csvandxml.ContactXml> contactsBook = readContacts(file);
		return contactsBook;
	}
